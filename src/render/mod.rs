...
fn bg_pallette(ppu: &PPU, tile_column: usize, tile_row: usize) -> [u8; 4] {
    ...
    let attr_byte: u8 = ppu.vram[0x03C0 + attr_table_idx]; // Note: still using hardcoded first nametable
